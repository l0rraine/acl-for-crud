...
<div class="form-group">
    ...
    <div class="col-sm-8">
        @include('crud::partials.select_form', ['select_name'=>'dep_id','datas'=>$deps, 'pinyin_search'=>1 ,'select_width'=>300,'dropdown_height'=>300])
    </div>
</div>
<div class="form-group">
...
<div class="form-group">
    ...
    <div class="col-sm-8">
        @include('partials.select_form', ['select_name'=>'role_ids','datas'=>$roles,  'title_attr'=>'name', 'multiple'=>1 ,'select_width'=>300])
    </div>
</div>
@endif